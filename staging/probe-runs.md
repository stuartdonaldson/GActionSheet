...
| 441f85ad-90c7-4c79-bb3f-e9e9575338b8 | 2026-06-02 | E2 | user2 (sanctuary@northlakeuu.org); clean run — all fixtures use user2 auth | direct /dev; user2 no add-on | 12/12; PROBE.menu missing (DriveApp auth triggered mid-run by syncAll); menu.identity clean; auth now granted for future runs |
