...
6. /adr/ _(Minimal)_ / /knowledge-base/adr/ _(Standard+)_ — why key decisions were made
7. /knowledge-base/references/ _(optional)_ — external document summaries
...
| Technical decisions | /adr/ _(Minimal)_ / /knowledge-base/adr/ _(Standard+)_ |
| Protocol details | /docs/interfaces/ _(optional)_ |
| External doc summaries | /knowledge-base/references/ _(optional)_ |
| Strategic themes | /knowledge-base/VISION.md _(optional — planning funnel)_ |
| Roadmap, funnel | /knowledge-base/ROADMAP.md _(optional — planning funnel)_ |
| Migration losses | /knowledge-base/ORPHANED-CONTENT.md _(optional)_ |
...
- Resolved decisions → /adr/ _(Minimal)_ / /knowledge-base/adr/ _(Standard+)_
