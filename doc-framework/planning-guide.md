...
A few paragraphs in `knowledge-base/staging/` or even inline in a conversation. Cover scope, known dependencies, and initial task breakdown.
...
```bash
rm knowledge-base/staging/pptx-control.md  # or git mv to docs/archive/
```
...
|---|---|---|
| **Theme** | `knowledge-base/VISION.md` | Stable goals. Reviewed annually. |
| **Funnel** | `knowledge-base/ROADMAP.md` — one-liners | "Aligned with a theme?" |
| **Review** | `knowledge-base/ROADMAP.md` — lean business case | "Value justifies effort and risk?" |
| **Staging** | `knowledge-base/staging/<n>.md` | "Can I write acceptance criteria?" |
...
```markdown
# knowledge-base/ROADMAP.md — Funnel
...
```markdown
# knowledge-base/ROADMAP.md — Reviewing
...
```markdown
# knowledge-base/staging/live-captioning.md
...
```bash
git rm knowledge-base/staging/live-captioning.md
```
...
|---------|----------|-----------|
| Strategic goals | `knowledge-base/VISION.md` | No |
| Speculative ideas | `knowledge-base/ROADMAP.md` — Funnel | No |
| Evaluated initiatives | `knowledge-base/ROADMAP.md` — Review | No |
| Work being scoped | `knowledge-base/staging/<n>.md` | Not yet |
| Enabler spikes | beads tasks, label `enabler` | Yes |
| Features and stories | beads epics/tasks | Yes |
| Formal decisions | `knowledge-base/adr/NNNN-*.md` | No |
