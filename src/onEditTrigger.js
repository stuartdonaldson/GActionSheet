 ...
 * §17).  When a user directly edits a mutable field in the Actions sheet, this
 * handler stamps the "Date Modified" cell in the edited row with the current
 * timestamp.
 *
 ...
 *   6=Document, 7=Date Created, 8=Date Modified
 */
...
function onActionSheetEdit(e) {
  try {
    ...
    GasLogger.log('onedit.date-modified.updated', { row: row });
  } catch (err) {
