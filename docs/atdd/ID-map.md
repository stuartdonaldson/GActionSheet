...
- **`T24` (generated traceability) is provisional and unbuilt here** — no JUnit emission or registry gap-diff exists. Build it in this project (it is the natural reference implementation) and feed corrections back into `sdlc-testing-principles.md`.
